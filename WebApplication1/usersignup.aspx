                  ...
                  <div class="row">
                   ...
                   <div class="row">
                       ...
                       <label>Contact Number</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" placeholder="Contact Number" ID="TextBox3" runat="server" TextMode="Number"></asp:TextBox>
                     </div>
                  </div>
                      ...
                      <label>Pincode</label>
                       ...
                       <label>Full Address</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" placeholder="Full Address" ID="TextBox5" runat="server" TextMode="MultiLine"></asp:TextBox>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col">
                               <center>  <span class="badge badge-primary">Login Credentials</span></center>
